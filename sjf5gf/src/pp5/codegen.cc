...
Location *CodeGenerator::GenTempVar()
{
  ...
  int offset = OffsetToFirstLocal + (4*nextTempNum); //calculates new offset value
  result = new Location(fpRelative, offset, NULL); //creates a new location with an appropriate offset
